...
public class Movii_RecargarCelular_Paquetes_Voz extends Movii_Core_Page
{
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Movii_RecargarCelular_Paquetes_Voz")) {
			throw new SkipException("Skipping the test as the Run mode is No");
		}
		else {
			movi();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Movii_RecargarCelular_Paquetes_Voz", "Test Case for Recargar Celular Paquetes");
		}
	}
