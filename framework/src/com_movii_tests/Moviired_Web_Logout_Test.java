...
public class Moviired_Web_Logout_Test  extends Movii_Core_Page  {
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Moviired_Web_Logout_Test")) {

			throw new SkipException("Skipping the test as the Run mode is No");

		} else {
			moviRedWeb();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Logout", "Test Case for Logout");
		}
	}
