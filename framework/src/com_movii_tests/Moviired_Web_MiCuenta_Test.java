...
public class Moviired_Web_MiCuenta_Test extends Movii_Core_Page {
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Moviired_Web_MiCuenta_Test")) {

			throw new SkipException("Skipping the test as the Run mode is No");

		} else {
			moviRedWeb();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Moviired_Web_MiCuenta_Test", "Test Case for Moviired_Web_MiCuenta_Test");
		}
	}
	...
	public void logout_verification() throws IOException {
		Moviired_login_obj.Moviired_Web_MiCuenta();
		Movii_Core_Page.logger.log(Status.INFO, "Logged In");
	}
	...
	public void afterMethod() {
		...
		System.out.println("Moviired_Web_MiCuenta_Test Test Complete therefore closing this session");
		w_driver.quit();
		} 
	}
