...
public class Movii_recharge_cellular extends Movii_Core_Page {
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Movii_recharge_cellular")) {
			throw new SkipException("Skipping the test as the Run mode is No");
		}
		else {
			movi();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Movii_recharge_cellular", "Test Case for successfull transaction Tu Dinero");
		}
	}
