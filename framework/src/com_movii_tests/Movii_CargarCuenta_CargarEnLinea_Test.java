...
public class Movii_CargarCuenta_CargarEnLinea_Test extends Movii_Core_Page
{
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Movii_CargarCuenta_CargarEnLinea_Test")) {
			throw new SkipException("Skipping the test as the Run mode is No");
		}
		else {
			movi();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Movii_CargarCuenta_CargarEnLinea_Test", "Test Case for Cargar En Linea");
		}
	}

	@Test(priority = 1)
	public void cargarEnLinea() throws IOException {
		login_obj.success_login();
		cargar.cargarEnLinea();
