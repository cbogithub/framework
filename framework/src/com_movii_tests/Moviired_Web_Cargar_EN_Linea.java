...
public class Moviired_Web_Cargar_EN_Linea extends Movii_Core_Page {
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Moviired_Web_Cargar_EN_Linea")) {

			throw new SkipException("Skipping the test as the Run mode is No");

		} else {
			moviRedWeb();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Moviired_Web_Cargar_EN_Linea", "Test Case for Moviired_Web_Cargar_EN_Linea");
		}
	}
	...
	public void logout_verification() throws IOException {
		Moviired_login_obj.CargarENLinea();
		Movii_Core_Page.logger.log(Status.INFO, "Logged In");
	}
	...
	public void afterMethod() {
		...
		System.out.println("Moviired_Web_Cargar_EN_Linea Test Complete therefore closing this session");
		w_driver.quit();
		} 
	}
}
