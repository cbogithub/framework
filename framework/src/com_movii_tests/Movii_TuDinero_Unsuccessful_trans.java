...
public class Movii_TuDinero_Unsuccessful_trans  extends Movii_Core_Page  {
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Movii_TuDinero_Unsuccessful_trans")) {
			throw new SkipException("Skipping the test as the Run mode is No");
		}
		else {
			movi();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Movii_TuDinero_Successful_transaction", "Test Case for unsuccessfull transaction Tu Dinero");
		}
	}
	...
	public void sucessful_transaction() throws IOException {
		...
		dinero.TuDinero_UnSuccessful_transaction();
