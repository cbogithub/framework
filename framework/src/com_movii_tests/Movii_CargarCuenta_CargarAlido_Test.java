...
public class Movii_CargarCuenta_CargarAlido_Test extends Movii_Core_Page
{
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Movii_CargarCuenta_CargarAlido_Test")) {
			throw new SkipException("Skipping the test as the Run mode is No");
		}
		else {
			movi();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Movii_CargarCuenta_CargarAlido_Test", "Test Case for Cargar Alido");
		}
	}
