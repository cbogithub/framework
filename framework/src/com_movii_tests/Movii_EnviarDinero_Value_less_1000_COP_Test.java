...
public class Movii_EnviarDinero_Value_less_1000_COP_Test extends Movii_Core_Page{
...
// User should not be able to send money below the minimum value that is 1000 COP.
	@Test(priority = 1)
	public void unsuccessfull_send_money_below_minimum_1000_COP() throws IOException
	{
		obj.send_money_below_minimum_1000_COP();
	}
