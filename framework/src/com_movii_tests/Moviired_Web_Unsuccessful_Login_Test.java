...
public class Moviired_Web_Unsuccessful_Login_Test extends Movii_Core_Page{
	...
	public void isSkip() throws MalformedURLException, IOException {
		if (!TestUtil.isExecutable("Moviired_Web_Unsuccessful_Login_Test")) {

			throw new SkipException("Skipping the test as the Run mode is No");

		} else {
			moviRedWeb();
			Movii_Core_Page.logger = Movii_Core_Page.report.createTest("Moviired_Web_Unsuccessful_Login_Test", "Test Case for Moviired_Web_Unsuccessful_Login_Test");
		}
	}

	@Test(priority = 1)
	public void login_verification() throws IOException {
		Moviired_login_obj.Unsuccessful_Login();
	...
	public void afterMethod() {
		...
		System.out.println("Moviired_Web_Unsuccessful_Login_Test Test Complete");
		w_driver.close();
		} 
	}
}
